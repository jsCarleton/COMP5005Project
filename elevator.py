...
print("-------------------")
for floors in floors_list:
    print("Normal distribution on", floors, "floors:", get_best_floors(get_normal_dist(floors), 1000))

for b in bimodal_params:
    print("Bimodal distribution on", b[0], "floors:", get_best_floors(get_bimodal_dist(b[0], b[1], b[2], b[3]), 1000))

for floors in floors_list:
    print("Exponential distribution on", floors, "floors:", get_best_floors(get_exp_dist(floors), 1000))

for floors in floors_list:
    print("Reverse exponential distribution on", floors, "floors:", get_best_floors(get_rev_exp_dist(floors), 1000))
print()
...
print("---------------------")
for floors in floors_list:
    print("Normal distribution,", floors, "floors:", opaque_model(get_normal_dist(floors), 1000))

for b in bimodal_params:
    print("Bimodal distribution,", b[0], "floors:", opaque_model(get_bimodal_dist(b[0], b[1], b[2], b[3]), 1000))

for floors in floors_list:
    print("Exponential distribution,", floors, "floors:", opaque_model(get_exp_dist(floors), 1000))

for floors in floors_list:
    print("Reverse exponential distribution,", floors, "floors:", opaque_model(get_rev_exp_dist(floors), 1000))
print()
